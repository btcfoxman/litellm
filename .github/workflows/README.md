...
# - Version: `1.74.11` â†’ Publishes as v1.74.11
# - Version: `1.74.10-hotfix1` â†’ Publishes as v1.74.10-hotfix1

## Features

# - âœ… Manual trigger with version input
# - âœ… Automatic version updates in `pyproject.toml`
# - âœ… Repository safety check (only runs on official repo)
# - âœ… Clean package building and publishing
# - âœ… Success confirmation with PyPI package link 
