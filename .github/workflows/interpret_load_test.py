...
#         - if a row has a median response time < 300 and an average response time < 300, Status = "Passed âœ…"
#         - if a row has a median response time >= 300 or an average response time >= 300, Status = "Failed âŒ"
...
#             ):
#                 row["Status"] = "Passed âœ…"
#             else:
#                 row["Status"] = "Failed âŒ"
...
#         + docker_run_command
#         + "\n\n"
#         + "### Don't want to maintain your internal proxy? get in touch ðŸŽ‰"
